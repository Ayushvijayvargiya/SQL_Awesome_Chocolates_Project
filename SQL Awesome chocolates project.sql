...
select Year(saleDate) as 'Year', Sum(amount)as Sales,Sum(Boxes)as Boxes,count(customers) as 'Total Customer' From Sales group by year(saledate) order By year(saledate);
select month(saleDate) as 'Month', Sum(amount)as Sales,Sum(Boxes)as Boxes,count(customers) as 'Total Customer' From Sales group by month(saledate) order By month(saledate);
